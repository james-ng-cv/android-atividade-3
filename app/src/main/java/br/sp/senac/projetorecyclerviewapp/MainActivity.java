...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstLivros.add(new Livros("Palmeiras","O Palmeiras é um clube de sao paulo","esta em 1 no campeonato brasileiro",R.drawable.palmeiras));
        lstLivros.add(new Livros("Santos","O Santos é um clube de sao paulo","esta em 2 no campeonato brasileiro",R.drawable.santos));
        lstLivros.add(new Livros("Gremio", "O Gremio é um clube do rio grande do sul", "esta em 3 no campeonato brasileiro", R.drawable.gremio));
